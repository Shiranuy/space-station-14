...
uplink-emp-implanter-official-name = Прототип имплантера ЭМИ
uplink-emp-implanter-official-desc = Изначальный прототип ЭМИ импланта, который не может перезаряжать заряды.
